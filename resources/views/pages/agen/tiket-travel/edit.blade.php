                            ...
                            <form action="{{ route('agen.tiket.travel.update', $tiket->id ) }}" method="POST" class="w-full" enctype="multipart/form-data">
                                ...
                                <div class="flex flex-wrap -mx-3 mb-6">
                                  <div class="w-full .min-w-full md:w-3/4 px-3 mb-6 md:mb-0">
                                    ...
                                    <input value="{{ $tiket->nama_tiket }}" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name="nama_tiket" id="nama_tiket" type="text" placeholder="Masukkan Nama Wisata">
                                  ...
                                  <div class="w-full md:w-1/4 px-3">
                                    ...
                                    <input value="{{ $tiket->harga }}" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name="harga" id="harga" type="number" placeholder="Masukkan Nama Wisata">
                                ...
                                <div class="flex flex-wrap -mx-3 mb-6">
                                  <div class="w-full px-3">
                                    ...
                                    <textarea rows="4" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="deskripsi" name="deskripsi">{{ $tiket->deskripsi }}</textarea>
