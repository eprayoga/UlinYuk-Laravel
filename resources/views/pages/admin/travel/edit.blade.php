...
@section('title')
    Edit Travel {{ $travel->nama_travel }}
@endsection
                ...
                <div class="min-w-screen min-h-screen bg-gray-100 flex justify-center font-sans overflow-hidden py-5">
                    <div class="w-full lg:w-5/6">
                        <h1 class="font-semibold text-xl text-gray-800 leading-tight">
                            Form Edit Data Travel {{ $travel->nama_travel }}
                        </h1>
                        <div class="bg-white shadow-md rounded my-6 py-5 px-5 flex justify-center">
                            <form action="{{ route('admin.data.travel.update', $travel->id) }}" method="POST" class="w-full" enctype="multipart/form-data" id="locations">
                                @csrf
                                <div class="flex flex-wrap -mx-3 mb-6">
                                  <div class="w-full .min-w-full md:w-2/4 px-3 mb-6 md:mb-0">
                                    ...
                                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" value="{{ $travel->nama_travel }}" name="nama_travel" id="nama_travel" type="text" placeholder="Masukkan Nama Wisata">
                                ...
                                <div class="flex flex-wrap -mx-3 mb-6">
                                  <div class="w-full px-3">
                                    ...
                                    <textarea rows="4" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="deskripsi" name="deskripsi">{{ $travel->deskripsi }}</textarea>
                                ...
                                <div class="flex flex-wrap -mx-3 mb-6">
                                  <div class="w-full px-3">
                                    ...
                                    <textarea rows="3" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="alamat" name="alamat" type="text">{{ $travel->alamat }}</textarea>
                                ...
                                <div class="flex flex-wrap -mx-3 mb-6">
                                    <div class="w-full px-3">
                                      ...
                                      <input rows="3" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" value="{{ $travel->gmap_link }}" id="gmap_link" name="gmap_link" type="text" />
