...
@section('title')
    Admin Edit Kategori {{ $kategori->nama_kategori }}
@endsection
                ...
                <div class="min-w-screen min-h-screen bg-gray-100 flex justify-center font-sans overflow-hidden py-5">
                    <div class="w-full lg:w-5/6">
                        <h1 class="font-semibold text-xl text-gray-800 leading-tight">
                            Form Edit Data Kategori {{ $kategori->nama_kategori }}
                        </h1>
                        <div class="bg-white shadow-md rounded my-6 py-5 px-5 flex justify-center">
                            <form action="{{ route('admin.data.kategori.update', $kategori->id) }}" method="POST" class="w-full" enctype="multipart/form-data" id="locations">
                                @csrf
                                <div class="flex flex-wrap -mx-3 mb-6">
                                    <div class="w-full px-3">
                                      ...
                                      <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="kategori" name="nama_kategori" type="text" value="{{ $kategori->nama_kategori }}" />
                                  </div>
                                </div>
