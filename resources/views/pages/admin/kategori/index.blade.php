        ...
        <div class="bg-white overflow-hidden sm:rounded-lg">
            <div class="min-w-screen min-h-screen bg-gray-100 flex justify-center font-sans overflow-hidden py-5">
                <div class="w-full lg:w-5/6">
                    <a href="{{ route('admin.data.kategori.create') }}" class="my-10 bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded">
                        Tambah Kategori
                      </a>
                        ...
                        <table class="min-w-max w-full table-auto">
                            <thead>
                                <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                    <th class="py-3 px-6 text-center">ID Kategori</th>
                            ...
                            <tbody class="text-gray-600 text-sm font-light">
                                @forelse ($kategoris as $kategori)
                                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                                        ...
                                        <td class="py-3 px-6 text-left">
                                                <span class="font-medium">{{ $kategori->slug }}</span>
                                        </td>
                                        <td class="py-3 px-6 text-center">
                                            <div class="flex item-center justify-center">
                                                <a href="{{ route('admin.data.kategori.edit', $kategori->id) }}">
                                                ...
                                                {{-- <form action="{{ route('admin.data.kategori.delete', $kategori->id) }}" method="post">
